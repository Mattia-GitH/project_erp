...
<div class="container">
    <div class="row justify-content-md-center">
        <div class="col-2">
            <form:form action="${pageContext.request.contextPath}/warehouse" modelAttribute="filter">
                <label for="sImei">Imei:</label>
                <input id="sImei" type="text" class="form-control" name="sImei"/>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${warehouses}" var="warehouse">
                        <tr>
                            ...
                            <td class="align-middle"><a class="btn btn-outline-primary text-end"
                                                        href="${pageContext.request.contextPath}/reports/${warehouse.imei}">reports</a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
